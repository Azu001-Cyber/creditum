"""
Django settings for creditum project.
...
WSGI_APPLICATION = 'creditum.wsgi.application'
...
PHONENUMBER_DEFAULT_REGION = 'NG' # Or your preferred default country code, e.g., 'GB', 'IN'
